    ...
    : wxFrame(parent, id, title, pos, size, style)
{
    ...
    m_glCanvas = new MyGLCanvas(m_mainPanel, wxID_ANY, m_glCanvasAttr, wxDefaultPosition, wxDLG_UNIT(m_mainPanel, wxSize(-1,-1)), 0);
    wxDELETEA( m_glCanvasAttr );
    
    boxSizer11->Add(m_glCanvas, 1, wxEXPAND, WXC_FROM_DIP(5));
